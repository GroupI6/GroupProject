...
public class database
{
  ...
  public static void openBusDatabase()
  {
    try
    {
      busDatabase = new database("13_COMP23420_I6",
              "13_COMP23420_I6",
              "Hgjev3rPGGnZWtrM",
  ...
  /* private Boolean SqlExecute(String sql_command)
  {
     try
     {
       Statement s = connection.createStatement();
       s.SqlExecute(sql_command);
       if (results != null) results.close();
       results = s.getResultSet();
       return true;
     }
  ...
  */
  ...
  public int get_int(String table, int id, String field_name)
  {
   ...
   public int get_int_new(String table, int id, String field_name)
  {
    select(field_name, table, "driver_id = " + id, "");
    if (move_first())
      return (Integer)get_field(field_name);
    else return 0;
  }

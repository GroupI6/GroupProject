...
public class DriverInfo 
{
   ...
   * the current calendar year.
   */
  public static void setHolidaysLength(int driver, int value)
  {
    if (driver == 0) throw new InvalidQueryException("Nonexistent driver");
    database.busDatabase.set_value("driver", driver, "holiday_length", value);
  }
 ...
 /**
   ...
   * the current calendar year.
   */
  public static void setControllerHolidaysLength(int driver, int value)
  {
    if (driver == 0) throw new InvalidQueryException("Nonexistent driver");
    database.busDatabase.set_value("driver", driver, "requested_length", value);
  }
   ...
   * current calendar year
   */
  public static int getHolidaysLength(int driver)
  {
    if (driver == 0) throw new InvalidQueryException("Nonexistent driver");
    return database.busDatabase.get_int("driver", driver, "holiday_length");
  }
   ...
   * current calendar year
   */
  public static int getControllerHolidaysLength(int driver)
  {
    if (driver == 0) throw new InvalidQueryException("Nonexistent driver");
    return database.busDatabase.get_int("driver", driver, "requested_length");
  }
   ...
   * current calendar year
   */
  public static int getHolidaysRequest(int driver)
  {
    if (driver == 0) throw new InvalidQueryException("Nonexistent driver");
    return database.busDatabase.get_int("driver", driver, "holiday_request");
  }
   ...
   * the current calendar year.
   */
  public static void setHolidaysRequest(int driver, int value)
  {
    if (driver == 0) throw new InvalidQueryException("Nonexistent driver");
    database.busDatabase.set_value("driver", driver, "holiday_request", value);
  }
